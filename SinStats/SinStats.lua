...
AddonTable.DisplayOrder = {
	{ hud="AP", init=true, grp=1, text=LOC["AP: "], textShort=LOC["AP: "], spell=29834, },	
	{ hud="RAP", init=false, grp=2, text=LOC["rAP: "], textShort=LOC["rAP: "], spell=34497, },	
	{ hud="DMG", init=false, grp=1, text=LOC["DMG: "], textShort=LOC["DMG: "], spell=29801, },
	{ hud="mDPS", init=false, grp=1, text="DPS: ", textShort="DPS: ", spell=29623, },	
	{ hud="RDMG", init=false, grp=2, text=LOC["rDMG: "], textShort=LOC["rDMG: "], spell=34482, },
	{ hud="rDPS", init=true, grp=2, text=LOC["rDPS: "], textShort=LOC["rDPS: "], spell=36554, },	
	{ hud="Fire", init=false, grp=3, text=LOC["Fire: +"], textShort=LOC["FIR: "], spell=34293, },	
	{ hud="Frost", init=true, grp=3, text=LOC["Frost: +"], textShort=LOC["FRO: "], spell=31674, },	
	{ hud="Arcane", init=false, grp=3, text=LOC["Arcane: +"], textShort=LOC["ARC: "], spell=31571, },
	{ hud="Shadow", init=true, grp=3, text=LOC["Shadow: +"], textShort=LOC["SHA: "], spell=30293, },		
	{ hud="Nature", init=false, grp=3, text=LOC["Nature: +"], textShort=LOC["NAT: "], spell=16578, },
	{ hud="Healing", init=true, grp=3, text=LOC["Healing: +"], textShort=LOC["HEAL: "], spell=26022, },
	{ hud="Holy", init=false, grp=3, text=LOC["Holy: +"], textShort=LOC["HOL: "], spell=31837, },			
	{ hud="Crit", init=false, grp=1, text=LOC["Crit: "], textShort=LOC["CRIT: "], spell=29859, }, 
	{ hud="CritBoss", init=false, grp=1, text=LOC["Crit+: "], textShort=LOC["CRIT+: "], spell=27140, }, 	
	{ hud="CritCap", init=true, grp=1, text=LOC["Crit Cap: "], textShort=LOC["CAP: "], spell=30819, }, 	
	{ hud="RangedCrit", init=false, grp=2, text=LOC["rCrit: "], textShort=LOC["rCRIT: "], spell=34506, },
	{ hud="RangedCritBoss", init=true, grp=2, text=LOC["rCrit+: "], textShort=LOC["rCRIT+: "], spell=33851, },
	{ hud="SpellCrit", init=true, grp=3, text=LOC["Spell Crit: "], textShort=LOC["sCRIT: "], spell=30288, },
	{ hud="SpellCritBoss", init=false, grp=3, text=LOC["Spell Crit+: "], textShort=LOC["sCRIT+: "], spell=17917, },	
	{ hud="Hit", init=true, grp=1, text=LOC["Hit: "], textShort=LOC["HIT: "], spell=31241, },
	{ hud="RangedHit", init=false, grp=2, text=LOC["rHit: "], textShort=LOC["rHIT: "], spell=34485, },
	{ hud="SpellHit", init=false, grp=3, text=LOC["Spell Hit: "], textShort=LOC["sHIT: "], spell=34935, },	
	{ hud="HasteMelee", init=true, grp=1, text=LOC["Haste: "], textShort=LOC["HAS: "], spell=31244, },
	{ hud="weaponSpeed", init=false, grp=1, text=LOC["Atk Speed: "], textShort=LOC["AS: "], spell=30664, },
	{ hud="HasteRanged", init=false, grp=2, text=LOC["rHaste: "], textShort=LOC["rHAS: "], spell=23989, },	
	{ hud="rangedSpeed", init=false, grp=2, text=LOC["rAtk Speed: "], textShort=LOC["rAS: "], spell=34948, },	
	{ hud="HasteCaster", init=false, grp=3, text=LOC["Spell Haste: "], textShort=LOC["sHAS: "], spell=30060, },	
	{ hud="ArmorPenetration", init=true, grp=1, text=LOC["Armor Pen: "], textShort=LOC["ArP: "], spell=26866, },	
	{ hud="Expertise", init=true, grp=1, text=LOC["Expertise: "], textShort=LOC["EXP: "], spell=30920, },			
	{ hud="MeleeMiss", init=false, grp=1, text=LOC["Miss: "] , textShort=LOC["MIS: "], spell=31858, },
	{ hud="MeleeBoss", init=false, grp=1, text=LOC["Miss+: "], textShort=LOC["MIS+: "], spell=1329, },
	{ hud="Avoidance", init=true, grp=1, text=LOC["Avoidance: "], textShort=LOC["AVD: "], spell=31223, },	
	{ hud="Crushing", init=false, grp=1, text=LOC["Crushing: "], textShort=LOC["CRS: "], spell=32175, },
	{ hud="CritReceived", init=false, grp=1, text=LOC["Get Crit: "], textShort=LOC["CRIT-: "], spell=33856, },	
	{ hud="RangedMiss", init=false, grp=2, text=LOC["rMiss: "], textShort=LOC["rMIS: "], spell=34460, },
	{ hud="RangedBoss", init=false, grp=2, text=LOC["rMiss+: "], textShort=LOC["rMIS+: "], spell=34491, },
	{ hud="SpellMiss", init=false, grp=3, text=LOC["Spell Miss: "], textShort=LOC["sMIS: "], spell=30108, },
	{ hud="SpellBoss", init=false, grp=3, text=LOC["Spell Miss+: "], textShort=LOC["sMIS+: "], spell=30706, },	
	{ hud="ManaRegen", init=false, grp=3, text=LOC["MP2: "], textShort=LOC["MP2: "], spell=31833, },
	{ hud="CastingRegen", init=false, grp=3, text=LOC["MP2 Casting: "], textShort=LOC["MP2+: "], spell=34861, },
	{ hud="MP5", init=true, grp=3, text=LOC["MP5: "], textShort=LOC["MP5: "], spell=29064, },
	{ hud="MP5Casting", init=true, grp=3, text=LOC["MP5 Casting: "], textShort=LOC["MP5+: "], spell=15017, },	
	{ hud="Armor", init=false, grp=1, text=LOC["Armor: "], textShort=LOC["ARM: "], spell=29140, },
	{ hud="Resilience", init=false, grp=1, text=LOC["Resilience: "], textShort=LOC["RES: "], spell=29623, },		
	{ hud="DMGReduc", init=false, grp=1, text=LOC["Mitigation: "], textShort=LOC["MIT: "], spell=871, },
	{ hud="Defense", init=false, grp=1, text=LOC["Defense: "], textShort=LOC["DEF: "], spell=32700, },
	{ hud="Dodge", init=false, grp=1, text=LOC["Dodge: "], textShort=LOC["DOD: "], spell=13981, },
	{ hud="Parry", init=false, grp=1, text=LOC["Parry: "], textShort=LOC["PAR: "], spell=3127, },
	{ hud="Block", init=false, grp=1, text=LOC["Block: "], textShort=LOC["BLO: "], spell=2565, },
	{ hud="FireResist", init=false, grp=4, text=LOC["Fire Res: "], textShort=LOC["FR: "], spell=18459, },
	{ hud="FrostResist", init=false, grp=4, text=LOC["Frost Res: "], textShort=LOC["FrR: "], spell=31667, },
	{ hud="ShadowResist", init=false, grp=4, text=LOC["Shadow Res: "], textShort=LOC["SR: "], spell=30283, },
    { hud="ArcaneResist", init=false, grp=4, text=LOC["Arcane Res: "], textShort=LOC["AR: "], spell=16850, },	
	{ hud="NatureResist", init=false, grp=4, text=LOC["Nature Res: "], textShort=LOC["NR: "], spell=30675, },  	
	{ hud="Speed", init=true, grp=5, text=LOC["Speed: "], textShort=LOC["SPE: "], spell=31641, },
	{ hud="Durability", init=true, grp=5, text=LOC["Durability: "], textShort=LOC["DUR: "], spell=3100, },
	{ hud="BuffCounter", init=false, grp=5, text=LOC["Buffs: "], textShort=LOC["BUF: "], spell=22888, },	
	{ hud="DebuffCounter", init=false, grp=5, text=LOC["Debuffs: "], textShort=LOC["DEB: "], spell=23154, },	
	{ hud="Lag", init=false, grp=5, text=LOC["Ping: "], textShort=LOC["LAG: "], spell=33592, },
	{ hud="FPS", init=false, grp=5, text=LOC["FPS: "], textShort=LOC["FPS: "], spell=19498, },	
	{ hud="Money", init=false, grp=5, text="", textShort="", spell=921, },	
}
...
local function initSinStatsDB()
	if not SinStatsDB then
		SinStatsDB = {
			...
			GroupOrder = false,
			OrderKey = 1,			
			StatFonts = GameFontNormal:GetFont(),
	...
	if not SinStatsDB.StatFonts then
		SinStatsDB.StatFonts = GameFontNormal:GetFont()
	end
...
local DBObject = LibStub("LibDataBroker-1.1"):NewDataObject("SinStats", {
	...
	OnTooltipShow = function(tooltip)
		...
		tooltip:AddLine("[|cff00f26dLeft Click|r] to |cffF2A427Open/Close|r the settings", 1, 1, 1)
		tooltip:AddLine("[|cff00f26dRight Click|r] to |cffF2A427Enable/Disable|r the stats HUD", 1, 1, 1)
		tooltip:AddLine("[|cff00f26dShift + Right Click|r] to |cffF2A427Lock/Unlock|r the stats HUD", 1, 1, 1)
		tooltip:Show()
	end,
...
if negBuff < 0 then
	SetText(self.Stats.Armor, self, "|cffd4080c" .. effectiveArmor .. "|r"); 
else
...
if negBuff < 0 then
	SetText(self.Stats.DMGReduc, self, "|cffd4080c" .. ("%.0f"):format(armorReduction) .. "%" .. "|r")  
else
...
if negBuff < 0 then
	SetText(self.Stats.RDMG, self, "|cffd4080c" .. ("%.0f"):format(hiDmg) .. "|r");    
else
...
if negBuff < 0 then		
	SetText(self.Stats.rDPS, self, "|cffd4080c" .. ("%.1f"):format(rangedDPS) .. "|r");
else
...
if negBuff < 0 then		
	SetText(self.Stats.DMG, self, "|cffd4080c" .. ("%.0f"):format(dmgeffect) .. "|r");
else
...
if negBuff < 0 then		
	SetText(self.Stats.mDPS, self, "|cffd4080c" .. ("%.1f"):format(meleeDPS) .. "|r");
else
...
if negBuff < 0 then	
	SetText(self.Stats.RAP, self, "|cffd4080c" .. effectiveRanged .. "|r");
else
...
critSpellChance = critSpellChance + combustionCount + arcaneMod + eleMastery + tidalMastery
...
SetText(self.Stats.SpellCrit, self, ("%.2f"):format(critSpellChance) .. "%" .. wintersChillEffect)
...
SetText(self.Stats.SpellCritBoss, self, ("%.2f"):format(critSpellChance) .. "%" .. wintersChillEffect)
--------------------------------------------------
...
elseif event == "UNIT_ATTACK_POWER" then
	...
	if negBuff < 0 then
		SetText(self.Stats.AP, self, "|cffd4080c" .. effectiveAP .. "|r"); 
	else
